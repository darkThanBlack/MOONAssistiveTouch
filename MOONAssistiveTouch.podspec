#
#  Be sure to run `pod spec lint MOONAssistiveTouch.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A short description of MOONAssistiveTouch."
  ...
  # Or just: s.author    = "moonShadow"
  # s.authors            = { "moonShadow" => "331614794@qq.com" }
  # s.social_media_url   = "http://twitter.com/moonShadow"
